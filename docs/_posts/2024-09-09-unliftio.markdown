...
No, that's not the case. Whether it becomes a practical problem depends on writing some practical programs, but at least when I personally created a small automation program using Heftia, it was not an issue. Here’s how to handle it.
